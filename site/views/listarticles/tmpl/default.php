...
if($this->count == 0){
    JFactory::getApplication()->redirect(JRoute::_('index.php?option=com_advancedopenportal&view=listcategories'),  JText::_('COM_ADVANCEDOPENKNOWLEDGEBASE_CATEGORY_NONE'), 'error');
}
else {
    ...
    <form id="adminForm" class="form-inline" name="adminForm" method="post"
          action="<?php echo JRoute::_('index.php?option=com_advancedopenportal&view=listarticles&id=' . $this->cat_id);?>">
